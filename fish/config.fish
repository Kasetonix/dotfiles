...
# configs
alias catpat='set_color -o yellow; cat /home/kasetonix/docs/gitpat; set_color white'
...
alias lh='exa -1 --icons --color=always --group-directories-first'
...
alias defwall='feh --bg-fill /home/kasetonix/Pictures/Wallpapers/Singles.jpg'
